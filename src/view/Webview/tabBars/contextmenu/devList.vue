<template>
	<div class="border-t border-slate-400/20 px-3 py-3">
		...
		<div @click="showItemInFolder" class="flex items-center rounded-md p-1 hover:bg-primary-400/20 hover:text-white">
		...
		<div @click="openFIle" class="flex items-center rounded-md p-1 hover:bg-primary-400/20 hover:text-white">
			<svg class="mr-2 h-5 w-5 flex-none stroke-slate-400" fill="none" viewBox="0 0 24 24" stroke-width="2"
				stroke-linecap="round" stroke-linejoin="round">
		...
		<div @click="trashItem" class="flex items-center rounded-md p-1 hover:bg-primary-400/20 hover:text-white">
			<svg class="mr-2 h-5 w-5 flex-none stroke-slate-400" fill="none" viewBox="0 0 24 24" stroke-width="2"
				stroke-linecap="round" stroke-linejoin="round">
				<path d="M9 13h6m-3-3v6m-9 1V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"></path>
			</svg>
