// import { FileIcons, IconPack } from './models';
...
export const fileIcons = [
	...
	{ name: 'read', fileExtensions: ['read'] },
	{ name: 'manifest', fileNames: ['manifest.json'] },
	{
		name: 'pug',
	...
	{ name: 'typescript', fileExtensions: ['etx', 'mts', 'ts'] },
	{
		name: 'typescript-def',
	...
	{
		name: 'zip',
		fileExtensions: ['zip', 'tar', 'gz', 'xz', 'lzma', 'lz4', 'br', 'bz2', 'bzip2', 'gzip', 'brotli', '7z', 'rar', 'tz', 'txz', 'tgz', 'zst'],
	},
	...
	{
		name: 'docker',
		fileExtensions: ['dockerignore', 'dockerfile', 'docker-compose.yml', 'docker-compose.yaml', 'containerignore', 'containerfile', 'compose.yaml', 'compose.yml'],
		fileNames: [
			'dockerfile',
			'dockerfile.prod',
	...
	{
		name: 'eslint',
		fileNames: ['.eslintrc.js', '.eslintrc.cjs', '.eslintrc.yaml', '.eslintrc.yml', '.eslintrc.json', '.eslintrc-md.js', '.eslintrc-jsdoc.js', '.eslintrc', '.eslintignore', '.eslintcache', 'eslint.config.js', 'eslint.config.mjs', '.eslintrc.base.json'],
	},
	{
		name: 'conduct',
	...
	{
		name: 'stylelint',
		fileNames: ['.stylelintrc', 'stylelint.config.js', 'stylelint.config.cjs', 'stylelint.config.mjs', '.stylelintrc.json', '.stylelintrc.yaml', '.stylelintrc.yml', '.stylelintrc.js', '.stylelintrc.cjs', '.stylelintignore', '.stylelintcache'],
		light: true,
	},
	{ name: 'code-climate', fileNames: ['.codeclimate.yml'], light: true },
	{
		name: 'prettier',
		fileNames: ['.prettierrc', 'prettier.config.js', 'prettier.config.cjs', '.prettierrc.js', '.prettierrc.cjs', '.prettierrc.json', '.prettierrc.json5', '.prettierrc.yaml', '.prettierrc.yml', '.prettierignore', '.prettierrc.toml', 'prettier.config.mjs', '.prettierrc.mjs'],
	},
	{
		name: 'renovate',
	...
	{
		name: 'istanbul',
		fileNames: ['.nycrc', '.nycrc.json', '.nycrc.yaml', '.nycrc.yml', 'nyc.config.js', '.istanbul.yml'],
	},
	...
	{
		name: '3d',
		fileExtensions: ['stl', 'stp', 'obj', 'glb', 'gltf', 'o', 'ac', 'blend', 'dxf', 'fbx', 'mesh', 'mqo', 'pmd', 'pmx', 'skp', 'vac', 'vdp', 'vox'],
	},
	...
	{
		name: 'textlint',
		fileNames: ['.textlintrc', '.textlintrc.js', '.textlintrc.json', '.textlintrc.yml', '.textlintrc.yaml'],
	},
	...
	{
		name: 'tauri',
		fileNames: ['tauri.conf.json', 'tauri.config.json', 'tauri.linux.conf.json', 'tauri.windows.conf.json', 'tauri.macos.conf.json', '.taurignore'],
...
export const fileNames: Map<string, FileIconItem> = new Map(fileIcons.map((item) => item?.fileNames?.map((name) => [name, item]) ?? []).flat() as [string, FileIconItem][]);
// const fileNames = fileIcons.map((item) => item?.fileNames?.map((name) => [name, item]) ?? []).flat();
export const fileExtensions: Map<string, FileIconItem> = new Map(fileIcons.map((item) => item?.fileExtensions?.map((name) => [name, item]) ?? []).flat() as [string, FileIconItem][]);