...
import YamlForm from "./yamlForm/index.vue";
...
async function getData() {
	fetch("apps://setting.api/root/getTemplate");				// 获取表单配置
	fetch("apps://setting.api/root/getData");					// 获取数据
	// fetch("apps://setting.api/root/setData", {				// 设置数据
	// 	method: 'POST',
	// 	body: JSON.stringify({
	// 		number: 454566,
	// 		background: "dsadvghbjkldsahgjkl"
	// 	})
	// });
}
