		...
		<div class="w-full h-full py-32 overflow-auto">
			...
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				<div class="mx-auto max-w-2xl lg:mx-0">
					<h2 class="text-4xl font-bold tracking-tight text-gray-600 dark:text-white sm:text-6xl">欢迎回来</h2>
					<p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">要看点什么？</p>
				</div>
			</div>
